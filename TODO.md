...
- [x] **WHAT:** Consider adding `Content-Length` validation for uploads.
      ...
      **HOW:** Added `enforceBodySizeLimit()` for JSON requests to validate actual body size. Documented Content-Length limitations and UploadThing's built-in limits in `docs/REQUEST_SIZE_VALIDATION.md`.

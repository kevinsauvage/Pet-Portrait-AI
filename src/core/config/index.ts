...
export const sitemap: MetadataRoute.Sitemap = [
  ...
  ...[
    config.routes.collection, config.routes.cart, config.routes.contact,
    config.routes.privacy, config.routes.refund, config.routes.shipping,
    config.routes.terms, config.routes.register, config.routes.login,
    config.routes.resetPassword, config.routes.emailResetPassword,
    config.routes.search, config.routes.logout, config.routes.updateAccount,
    config.routes.createAddress, config.routes.editAddress,
    config.routes.updateAddress, config.routes.addresses,
    config.routes.wishlist, config.routes.orders,
